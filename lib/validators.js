...
export const projectValidation = Joi.object({
  ...
  statut: Joi.string()
    .valid('Planification', 'En cours', 'En pause', 'Terminé', 'Annulé')
    .optional(),
});
...
export const taskValidation = Joi.object({
  ...
  // Statut - aligned with model enum (French with capitals)
  statut: Joi.string()
    .valid('Backlog', 'À faire', 'En cours', 'Review', 'Terminé')
    .default('Backlog'),
