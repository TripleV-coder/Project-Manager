...
class UserService {
  ...
  async getUserByEmail(email) {
    ...
    return User.findOne({ email }).populate('role_id').lean();
  }
  ...
  async updateLastLogin(userId) {
    ...
    return User.findByIdAndUpdate(userId, { dernière_connexion: new Date() }, { new: true }).lean();
  }
  ...
  async updateUserRole(userId, roleId) {
    ...
    return User.findByIdAndUpdate(userId, { role_id: roleId }, { new: true })
      .populate('role_id')
      .lean();
  }
