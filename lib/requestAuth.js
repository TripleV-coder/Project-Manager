...
/**
 * Shape this module relies on from a Mongoose `User` document (with
 * `role_id` populated). Not the full model — just the fields these
 * request-auth helpers read or write.
 * @typedef {object} AuthUser
 * @property {{ toString: () => string }} _id
 * @property {string} email
 * @property {string} nom_complet
 * @property {{ _id?: unknown, nom?: string, description?: string, permissions?: Record<string, boolean>, visibleMenus?: unknown } | null | undefined} role_id
 * @property {number} [tokenVersion]
 * @property {string} [avatar]
 * @property {string} [poste_titre]
 * @property {string} [département_équipe]
 * @property {string[]} [compétences]
 * @property {string} [status]
 * @property {boolean} [first_login]
 * @property {boolean} [must_change_password]
 * @property {unknown} [projets_assignés]
 * @property {boolean} [twoFactorEnabled]
 * @property {string} [currentRefreshJti]
 ...
 * @param {AuthUser} user - Mongoose user document with populated role_id
 ...
 * @param {import('next/server').NextResponse} response
 * @param {AuthUser} user - Mongoose user with populated role_id
