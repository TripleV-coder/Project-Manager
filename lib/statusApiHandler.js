...
import { executeStatusTransition, formatStatusInfo } from './statusTransitionUtils';
 ...
 */
export async function handleStatusChangeApi(entity, entityType, newStatus, user, options = {}) {
  const { saveFunc = null, auditFunc = null, emitFunc = null, validateFunc = null } = options;
  ...
  if (!transitionResult.success) {
    return NextResponse.json({ error: transitionResult.message }, { status: 400 });
  }
