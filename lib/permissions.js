...
/** @typedef {import('@/types/models').IPermissions} IPermissions */
/** @typedef {import('@/types/models').IVisibleMenus} IVisibleMenus */
/** @typedef {import('@/types/models').PermissionKey} PermissionKey */
