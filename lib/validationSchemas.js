...
export const validationSchemas = {
  ...
  // Task - aligned with Task model schema
  createTask: z.object({
    ...
    date_début: z.string().datetime().optional(),
    date_échéance: z.string().datetime().optional(),
    estimation_heures: z.number().positive().optional(),
  ...
  updateTask: z.object({
    ...
    statut: z.enum(['Backlog', 'À faire', 'En cours', 'Review', 'Terminé']).optional(),
    priorité: z.enum(['Basse', 'Moyenne', 'Haute', 'Critique']).optional(),
    assigné_à: z.string().nullable().optional(),
    sprint_id: z.string().nullable().optional(),
    deliverable_id: z.string().nullable().optional(),
    date_début: z.string().datetime().nullable().optional(),
    date_échéance: z.string().datetime().nullable().optional(),
    estimation_heures: z.number().positive().nullable().optional(),
    temps_réel: z.number().min(0).optional(),
    story_points: z.number().positive().nullable().optional(),
    labels: z.array(z.string()).optional(),
    tags: z.array(z.string()).optional(),
    ordre_priorité: z.number().optional(),
    colonne_kanban: z.string().optional()
  }),

  // Comment - aligned with Comment model schema
  ...
  // File - aligned with entity types
  createFile: z.object({
