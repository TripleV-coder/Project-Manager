...
import { getVisibleMenus, isMenuVisible, getMergedPermissions, ALL_MENUS } from '@/lib/permissions';
...
describe('Menu Visibility by Role', () => {
  ...
  describe('Project Role Restrictions (Most Restrictive)', () => {
    ...
    it('should restrict menus at project level', () => {
      ...
      const merged = getMergedPermissions({ role_id: { ...systemRole } }, projectRole);
