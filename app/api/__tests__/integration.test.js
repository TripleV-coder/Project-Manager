...
describe('API Integration Tests', () => {
  ...
  describe('Project API Integration', () => {
    ...
    describe('POST /api/projects', () => {
      ...
      it('should validate required fields', async () => {
        ...
        projectService.createProject.mockRejectedValue(new Error('nom is required'));

        await expect(projectService.createProject(invalidData, 'user-123')).rejects.toThrow(
          'nom is required'
        );
      });
    });
  ...
  describe('Task API Integration', () => {
    ...
    describe('POST /api/projects/:id/tasks', () => {
      ...
      it('should fail if project does not exist', async () => {
        ...
        await expect(taskService.createTask(taskData, 'user-123')).rejects.toThrow(
          'Projet non trouvé'
        );
      });
    });
  ...
  describe('User API Integration', () => {
    ...
    describe('POST /api/users', () => {
      ...
      it('should not allow duplicate emails', async () => {
        ...
        await expect(userService.createUser(userData)).rejects.toThrow('Email déjà utilisé');
      });
    });
    ...
    describe('PUT /api/users/:id/password', () => {
      ...
      it('should fail with wrong old password', async () => {
        ...
        userService.updatePassword.mockRejectedValue(new Error('Mot de passe ancien incorrect'));
    ...
    describe('POST /api/auth/login', () => {
      it('should authenticate user with valid credentials', async () => {
        ...
        const result = await userService.verifyCredentials(credentials.email, credentials.password);
  ...
  describe('Error Handling', () => {
    ...
    it('should handle service errors gracefully', async () => {
      projectService.getAccessibleProjects.mockRejectedValue(new Error('Database query failed'));

      await expect(projectService.getAccessibleProjects('user-123', {})).rejects.toThrow(
