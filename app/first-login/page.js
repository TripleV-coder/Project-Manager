...
import { hasAuthSessionMarker, markAuthSession } from '@/lib/client-auth';
...
export default function FirstLogin() {
  ...
  const passwordRequirements = [
    {
      met: formData.new_password.length >= 8 && formData.new_password.length <= 128,
      text: '8-128 caractères',
    },
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 auth-page-bg p-4">
        ...
        >
          ...
          <Card className="auth-card-shell shadow-xl border-0">
            <CardHeader>
              ...
              <CardDescription>
                Saisissez le mot de passe temporaire qui vous a été remis, puis définissez votre mot
                de passe définitif.
              </CardDescription>
            </CardHeader>
