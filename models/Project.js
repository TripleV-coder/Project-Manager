...
const projectSchema = new mongoose.Schema(
  {
    ...
    description: String,
    template_id: { type: mongoose.Schema.Types.ObjectId, ref: 'ProjectTemplate', default: null },

    // Contexte & Objectifs
    contexte: String,
    objectifs: String,
    termes_de_reference: String, // Peut contenir du texte ou une URL/référence vers un document
